...
<html>
  <head>
    ...
    <title>My JSP 'alterCheck.jsp' starting page</title>
  ...
  <body>
    <%
       ...
       if(username.equals("")){
         response.sendRedirect("http://localhost:8080/CCMS/userSelf/userServer.html");
         }
         else{
             ...
             String sql=" update userId set username='"+username+"' ,password='"+password+"',love='"+love+"',professional='"+professional+"',sex='"+sex+"',email='"+email+"',birth='"+birth+birth1+birth2+"',location='"+location+"' where username='"+username+"'";
